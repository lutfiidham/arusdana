            ...
            <div class="card-body">
                <form class="forms-sample" id="form" method="POST" action="javascript:;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_unit_kerja" id="kode_unit_kerja">
                        <span class="help-block"></span>
                    </div>

                    <div class="form-group">
                        <label for="nama_unit_kerja">Nama Unit Kerja</label>
                        <input type="text" class="form-control" name="nama_unit_kerja" id="nama_unit_kerja" required>
                        <span class="help-block"></span>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#tabel').dataTable({
            ...
            "scrollX":true,
            "ajax":{
                url : mys.base_url+'unit_kerja/get_data',
                type : 'GET',
            },
            "language": {
    ...
    function ubah_data(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'unit_kerja/get_data_by_id',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function simpan(){
        mys.blok()
        $.ajax({
            url: mys.base_url+'unit_kerja/save',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form').serialize(),
            success: function(data){
