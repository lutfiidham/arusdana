        ...
        <div class="card" id="form_card" style="display: none">
            ...
            <div class="card-body">
                <form class="forms-sample" id="form" method="POST" action="javascript:;">
                    <input type="hidden" name="id_tipe_customer" id="id_tipe_customer">
                    <div class="form-group">
                        <label for="nama_tipe_customer">Nama Tipe Customer</label>
                        <input type="text" class="form-control" name="nama_tipe_customer" id="nama_tipe_customer" required>
                        <span class="help-block"></span>
                    </div>

                    <div class="form-group">
                        <label for="status_tipe_customer">Status Tipe Customer</label>
                        <select name="status_tipe_customer" id="status_tipe_customer" class="form-control cmb_select2" required="required">
                            <option ></option>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#tabel').dataTable({
            ...
            "scrollX":true,
            "ajax":{
                url : mys.base_url+'tipe_customer/get_data',
                type : 'GET',
            },
            "language": {
    ...
    function ubah_data(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'tipe_customer/get_data_by_id',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(data){
                ...
                $('#id_tipe_customer').val(data.id_tipe_customer);
                $('#nama_tipe_customer').val(data.nama_tipe_customer);
                $('#status_tipe_customer').val(data.status_tipe_customer).trigger('change');
            },
            error:function(data){
    ...
    function simpan(){
        mys.blok()
        $.ajax({
            url: mys.base_url+'tipe_customer/save',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form').serialize(),
            success: function(data){
    ...
    function hapus(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'tipe_customer/delete',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
