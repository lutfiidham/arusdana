            ...
            <div class="card-body">
                <form class="forms-sample" id="form" method="POST" action="javascript:;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_bagian" id="kode_bagian">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_bagian" id="status_bagian" class="form-control cmb_select2" required="required">
                            <option ></option>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#tabel').dataTable({
            ...
            "scrollX":true,
            "ajax":{
                url : mys.base_url+'Bagian/get_data',
                type : 'GET',
            },
            "language": {
    ...
    function ubah_data(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'bagian/get_data_by_id',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(data){
                ...
                $('#status_bagian').val(data.status_bagian).trigger('change');
    ...
    function hapus(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'Bagian/delete',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
