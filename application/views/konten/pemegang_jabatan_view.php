...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#tabel').dataTable({
            ...
            "scrollX":true,
            "ajax":{
                url : mys.base_url+'pemegang_jabatan/get_data',
                type : 'GET',
            },
            "language": {
    ...
    function ubah_data(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'pemegang_jabatan/get_data_by_id',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function simpan(){
        mys.blok()
        $.ajax({
            url: mys.base_url+'pemegang_jabatan/save',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form').serialize(),
            success: function(data){
    ...
    function hapus(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'pemegang_jabatan/delete',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
