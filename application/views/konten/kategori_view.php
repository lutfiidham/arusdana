...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#tabel').dataTable({
            ...
            "scrollX":true,
            "ajax":{
                url : mys.base_url+'kategori/get_data',
                type : 'GET',
            },
            "language": {
        ...
        $('#btnAdd').on('click', function(event) {
            buka_form();
            $('#kode_kategori').prop('readonly', false);
        });
    ...
    function ubah_data(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'kategori/get_data_by_id',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function simpan(){
        mys.blok()
        $.ajax({
            url: mys.base_url+'kategori/save',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form').serialize(),
            success: function(data){
    ...
    function hapus(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'kategori/delete',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
