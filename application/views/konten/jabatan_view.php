            ...
            <div class="card-body">
                <form class="forms-sample" id="form" method="POST" action="javascript:;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_jabatan" id="status_jabatan" class="form-control cmb_select2" required="required">
                            <option ></option>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#tabel').dataTable({
            ...
            "scrollX":true,
            "ajax":{
                url : mys.base_url+'jabatan/get_data',
                type : 'GET',
            },
            "language": {
    ...
    function ubah_data(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'jabatan/get_data_by_id',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function hapus(id){
        mys.blok()
        $.ajax({
            url: mys.base_url+'jabatan/delete',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
